...
int start() {
   ...
   // Create a 2 functions to calculate volatilty Stop Loss and Take Profit (in pips) respectively
   ...
   // Create a function to calculate position size
   ...
   */
   ...
   // Create Entry rules using a function
...
// We didn't use the Cross function but it is a good habit to keep the functions here for potential future use
