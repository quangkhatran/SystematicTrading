...
int start() {
   ...
   //+------------------------------------------------------------------+
      ...
      ENTRY RULES:
      - If Current Volatility (ATR(20)) is less than Volatility (ATR(20)) 10 hours ago:
         1. Enter a long trade when closing price crosses Keltner Channels(20) from bottom
         2. Enter a short trade when closing price crosses Keltner Channels(20) from top
      - No trade on Mondays
      - No trade on first day of the month
      */
